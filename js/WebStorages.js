...
```js
localStorage.setItem('firstName', 'Bharath') // since the value is string we do not stringify it
console.log(localStorage)
```

```sh
Storage {firstName: 'Bharath', length: 1}
```
...
```sh
 Storage {age: '200', firstName: 'Bharath', length: 2}
```
...
```sh
Storage {age: '200', firstName: 'Bharath', skills: 'HTML,CSS,JS,React', length: 3}
```
